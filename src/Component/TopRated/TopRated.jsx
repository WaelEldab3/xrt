...
export default function TopRated() {
  return (
    <>
      <div className="flex py-[30px] px-[70px]">
        <div
        ...
        >
          ...
          <span className="text-[20px] font-[600]  text-white mt-[30px]">
            Enjoy Up to <span className="text-[#F5B400]"> {coupons.offer}</span>{" "}
            OFF
          </span>
        ...
        <div className="ml-[30px] w-[75%]">
          <h2 className="text-3xl font-[700] text-[#2F3E30] mb-3">Top Rated</h2>
