  ...
  return (
    <>
        <div className='bg-[#F2F7F3] py-[8px] flex header-container nav'>
            <h6 className='text-gray-500 lg:text-[16px] md:text-[14px] text-[11px]'>{props.address}</h6>
            <a href={props.email}>
              <div className="right_side flex items-center cursor-pointer group">
                ...
                <h5 className='text-gray-500 font-normal lg:text-[16px] md:text-[14px] text-[11px] duration-500 group-hover:text-[#58d793]'>{props.email}</h5>
              </div>
            </a>
        </div>
    </>
